...
export async function surpassedRecordMessage(message: Message<boolean>, user: GuildMember, record:number) {
...
export async function excludeUser(permissions:PermissionOverwriteManager, user:GuildMember) {
